...
def query_sm_endpoint(query, filters={}, top_k_reader=5, top_k_retriever=5) -> Tuple[List[Dict[str, Any]], Dict[str, str]]:
    """
    ...
    res2 = json.loads(res['Body'].read().decode())
    response = json.loads(res2['response'])
